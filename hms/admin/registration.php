...
if (isset($_POST['submit'])) {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO users (fullName, address, city, gender, email, password) VALUES (?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "ssssss", $fname, $address, $city, $gender, $email, $password);
