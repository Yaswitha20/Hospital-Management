...
if (isset($_POST['submit'])) {
    $doctorspecilization = mysqli_real_escape_string($bd, $_POST['doctorspecilization']);
    $sql = mysqli_query($bd, "INSERT INTO doctorSpecilization(specilization) VALUES('$doctorspecilization')");
...
if (isset($_GET['del']) && isset($_GET['id'])) {
    ...
    $sql = mysqli_query($bd, "DELETE FROM doctorSpecilization WHERE id = '$id'");
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql = mysqli_query($bd, "SELECT * FROM doctorSpecilization");
$cnt = 1;
