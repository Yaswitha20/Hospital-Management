...
$currentTime = date('Y-m-d H:i:s'); // use standard SQL datetime format
...
if (isset($_POST['submit'])) {
    $spec = mysqli_real_escape_string($bd, $_POST['doctorspecilization']);

    $query = "UPDATE doctorSpecilization SET specilization='$spec', updationDate='$currentTime' WHERE id='$id'";
    if (mysqli_query($bd, $query)) {
        $_SESSION['msg'] = "Doctor Specialization updated successfully !!";
    } else {
        $_SESSION['msg'] = "Error updating specialization: " . mysqli_error($bd);
    }
}
