...
if (isset($_POST['submit'])) {
    ...
    $password = md5($_POST['npass']);  // You can also use better encryption (bcrypt or argon2) in production

    // Use prepared statements to prevent SQL injection
    $stmt = mysqli_prepare($bd, "INSERT INTO doctors (specilization, doctorName, address, docFees, contactno, docEmail, password) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>alert('Failed to add doctor info. Please try again.');</script>";
    }
